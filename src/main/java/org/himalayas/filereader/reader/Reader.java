...
public abstract class Reader {
    ...
    private File doneArchiveFile = null;
    private File repeatArchiveFile = null;
     ...
     * @return
     */
    private boolean renameSourceFile() {
        if (Config.renameKDF) {
    ...
    private boolean renameKDFFile(Config.KdfRename rename) {
        if (Config.renameKDF) {
    ...
    public boolean renameOrArchiveKDF(File destinationFile, Config.KdfRename rename) {
    ...
    private boolean moveFileToArchive(File destinationFile) {
        try {
    ...
    public Config.FailureCase getFailType() {
        return failType;
    }
